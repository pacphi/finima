...
| ADR                                                      | Title                                               | Status   |
| -------------------------------------------------------- | --------------------------------------------------- | -------- |
| [ADR-001](ADR-001-rust-multi-crate-workspace.md)         | Rust Multi-Crate Workspace Architecture             | Accepted |
| [ADR-002](ADR-002-passwordless-auth-magic-links.md)      | Passwordless Authentication via Magic Links         | Accepted |
| [ADR-003](ADR-003-local-llm-gemma4-categorization.md)    | Local LLM (Gemma 4) for Transaction Categorization  | Accepted |
| [ADR-004](ADR-004-postgresql-single-datastore.md)        | PostgreSQL as the Single Data Store                 | Accepted |
| [ADR-005](ADR-005-multi-format-file-import.md)           | Multi-Format File Import Strategy                   | Accepted |
| [ADR-006](ADR-006-react-vite-zustand-frontend.md)        | React + Vite + Zustand Frontend Stack               | Accepted |
| [ADR-007](ADR-007-websocket-realtime-progress.md)        | WebSocket for Real-Time Progress Updates            | Accepted |
